...
def train():
    ...
    #     with fluid.unique_name.guard():
    #         test_model = core.init_test_model(conf, paths.output) #TODO  
    #         test_out = test_model.net(img,class_dim=args.num_classes) 
    ...
    train_compile_prog = fluid.compiler.CompiledProgram(
            train_prog).with_data_parallel(loss_name="TODO", #train_loss.name,
